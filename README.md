...
### Personalisation des logos

Certains modules comme payzen et systempay propose plusieurs types de cartes
les logos sont donc aussi utilisés dans l'espace privé, a coté des cases a cocher.

l'utilisation du svg ne casse pas les listes du privé, elles sont juste un peut petites.

L'utilisation de balise_img pour les logos limite a spip 3.2.5+
https://www.spip.net/fr_article4003.html
...
Visa :
https://commons.wikimedia.org/wiki/File:Former_Visa_(company)_logo.svg
